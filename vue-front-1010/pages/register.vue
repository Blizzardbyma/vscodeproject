  ...
  <div class="main">
    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="params">
        ...
        <el-form-item class="input-prepend restyle" prop="email" :rules="[{ required: true, message: '请输入你的邮箱', trigger: 'blur' }]">
          <div>
            <el-input type="text" placeholder="你的邮箱" v-model="params.email"/>
            <i class="iconfont icon-user"/>
          </div>
        </el-form-item>
